...
items = [
    Item("Key Word", "keyword 0", True, False, KEYWORD, 0x00),
    Item("Key Word", "keyword 1", True, False, KEYWORD, 0x01),
    Item("Key Word", "keyword 2", True, False, KEYWORD, 0x02),
    Item("Key Word", "keyword 3", True, False, KEYWORD, 0x03),
    ...
    Item("Red ID Card", "red card", True, True, NORMAL, 0x06),
    Item("Floppy Disk", "floppy", True, True, NORMAL, 0x07),

    Item("Bread", "bread", False, False, NORMAL, 0x08),
    Item("Opa-Opa", "level", True, True, NORMAL, 0x09),
    Item("Zillion", "gun", True, True, NORMAL, 0x0A),
    Item("Scope", "scope", False, True, NORMAL, 0x0B),
    # custom items here

    # rescue
    Item("Apple", "rescue 0", True, True, RESCUE, 0x00),
    Item("Champ", "rescue 1", True, True, RESCUE, 0x01),
]
